...
.additional-links { text-align: center; margin-top: 1.5rem; padding-top: 1.5rem; border-top: 1px solid #ddd; }
.additional-links a { color: #666; text-decoration: none; font-size: 0.9rem; }
...
<div class="login-wrapper">
    <div class="login-container">
        ...
        <form action="${pageContext.request.contextPath}/LoginExecute.action" method="post" id="loginForm">
